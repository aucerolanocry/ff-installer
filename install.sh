...
if [ -d "$STORAGE" ]; then
    # Permissão já concedida, pula direto
    echo -e "\033[1;32m[✔] Permissão de armazenamento já concedida! Continuando...\033[0m"
    sleep 1
else
    # Aviso rápido de permissão
    echo -e "\033[1;33m┌───────────────────────────────┐\033[0m"
    echo -e "\033[1;33m│ ⚠︎ Permissão de armazenamento │\033[0m"
    echo -e "\033[1;33m│     necessária!               │\033[0m"
    echo -e "\033[1;33m└───────────────────────────────┘\033[0m"
    sleep 2.5
    
    # Solicita permissão
    termux-setup-storage
    echo -e "\033[1;32m[✔] Permissão concedida! Continuando...\033[0m"
    sleep 1
fi
clear
