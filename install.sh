...
if [ -d "$STORAGE" ]; then
    ...
    echo -e "\033[1;37m│\033[1;32m           ⛥  ARMAZENAMENTO JÁ CONFIGURADO             \033[1;37m│\033[0m"
    echo -e "\033[1;37m├─────────────────────────────────────────────────────────┤\033[0m"
    echo -e "\033[1;37m│  \033[1;32m⛥  Permissão já concedida                           \033[1;37m│\033[0m"
    echo -e "\033[1;37m│  \033[1;32m⛥  Continuando...                                   \033[1;37m│\033[0m"
    echo -e "\033[1;37m└─────────────────────────────────────────────────────────┘\033[0m"
    sleep 1.5
else
    ...
    if [ "$menu" = "1" ]; then
        ...
        while true; do
            ...
            if [ "$obb" = "1" ]; then
                ...
                echo ""
                echo -e "$red [☠︎] Opção inválida! Digite 0, 1 ou 2${reset}"
                sleep 2
            fi
        done
